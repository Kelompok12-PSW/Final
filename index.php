    ...
    <div class="container">
        ...
        <div class="col">
            <button type="text" class="btn btn-warning" placeholder="First name" aria-label="First name">
                <a href="../login_dosen/login_dosen.php" style="color: black; padding-left: 26px; padding-right: 26px;">Login Dosen</a>
            </button>
        </div>
        <div class="col">
            <button type="password" class="btn btn-warning" placeholder="Last name" aria-label="Last name">
                <a href="../login_mahasiswa/login_mahasiswa.php" style="color: black; padding-left: 10px; padding-right: 10px;">Login Mahasiswa</a>
            </button>
        </div>
        </div> 
    </div>
